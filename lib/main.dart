...
import 'package:flutter_native_uikit_module/common/bottom_sheets/app_settings_bottom_sheet.dart';
import 'package:flutter_native_uikit_module/home_screen/user_detail_screen.dart';
import 'package:flutter_native_uikit_module/home_screen/qr_code_screen.dart';
...
class _HMSExampleAppState extends State<HMSExampleApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/': (context) => HomePage(deepLinkURL: _currentURI==null?null:_currentURI.toString(),),
...
class TestRoute extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        color: Colors.red,
        child: Center(child: Text("Test Route...",style: TextStyle(color: Colors.white,fontSize: 30),)),
      ),
    );
  }
